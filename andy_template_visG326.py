...
component_filename = PROJECT_PATH + 'SDC326_n2h+_TP+7m+12m.image.pbcor_maps.pkl'

data_2d_paths = [component_filename]
data_2d_labels = ['chisq_red']

data_3d_path = PROJECT_PATH + 'SDC326_n2h+_TP+7m+12m.image.pbcor.fits'
data_3d_fit_upper_lower_path = PROJECT_PATH + 'SDC326_n2h+_TP+7m+12m.image.pbcor_fit_cube.npy'
...
# If you want to see the paramers for each induvidual fit
