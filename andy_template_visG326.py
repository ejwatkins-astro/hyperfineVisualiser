...
#with a label for each component, and the label names ascend as
...
#run the visuliser: copy the address into the url. Works with chrome and firefox.
#Have not tested if it works for other browsers...
vis.run_visualiser()
